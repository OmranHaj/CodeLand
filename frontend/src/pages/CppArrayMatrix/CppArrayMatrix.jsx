...
const LEVEL_ID = "cpp-array-matrix";
...
function saveProgress(userId, progress) {
  try {
    ...
    console.error(
      "[CodeLand] Unable to save C++ Array Matrix progress:",
      error,
    );
  }
}
...
function CppArrayMatrix() {
  ...
  const content = cppArrayMatrixContent;
  ...
  const robotMessage =
    robotReaction.type === "happy"
      ? "Excellent. Array Matrix channels are processing collection data correctly."
      : robotReaction.type === "sad"
        ...
        : runnerAvailable
          ...
          : "Matrix Terminal is online. Backend compilation comes next.";
              ...
              <>
                <div className={styles.eyebrow}>
                  {activeUnit.kind === "lesson" ? (
                    <>
                      <Code2 size={13} />
                      MATRIX TRAINING {activeUnitIndex + 1}
                    </>
                  ) : (
                    <>
                      <Trophy size={13} />
        ...
        >
          <div className={styles.chamberHeader}>
            <div>
              ...
              <strong>C++17 Matrix Runtime</strong>
            </div>
      ...
      {levelComplete && (
        <div className={styles.completeOverlay}>
          <div className={styles.completeCard}>
            ...
            <span>ARRAY MATRIX ONLINE</span>

            <h2>Memory Vault Unlocked</h2>
