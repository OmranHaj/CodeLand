...
import styles from "./CppDataCircuits.module.css";

const LEVEL_ID = "cpp-data-circuits";
...
function saveProgress(userId, progress) {
  try {
    ...
    console.error(
      "[CodeLand] Unable to save C++ Data Circuits progress:",
      error,
    );
  }
}
...
const DATA_ROBOT_FRAME = {
  cameraPosition: [0, 0.18, 3.15],
  cameraTarget: [0, -0.28, 0],
  modelPosition: [0, -0.55, 0],
  modelRotation: [0, -0.06, 0],
  modelScale: 0,
};
...
function CppDataCircuits() {
  ...
  const content = cppDataCircuitsContent;
  ...
  const robotMessage =
    robotReaction.type === "happy"
      ? "Excellent. Data Circuits are carrying clean signals."
      : robotReaction.type === "sad"
        ...
        : runnerAvailable
          ...
          : "Data Terminal is online. Backend compilation comes next.";
          ...
          <div className={styles.robotCard}>
            <div className={styles.robotStage}>
              <LessonRobot
                ...
                cameraPosition={DATA_ROBOT_FRAME.cameraPosition}
                cameraTarget={DATA_ROBOT_FRAME.cameraTarget}
                modelPosition={DATA_ROBOT_FRAME.modelPosition}
                modelRotation={DATA_ROBOT_FRAME.modelRotation}
                modelScale={DATA_ROBOT_FRAME.modelScale}
              />
              ...
              <>
                <div className={styles.eyebrow}>
                  {activeUnit.kind === "lesson" ? (
                    <>
                      <Code2 size={13} />
                      DATA TRAINING {activeUnitIndex + 1}
                    </>
                  ) : (
                    <>
                      <Trophy size={13} />
        ...
        >
          <div className={styles.chamberHeader}>
            <div>
              ...
              <strong>C++17 Data Runtime</strong>
            </div>
      ...
      {levelComplete && (
        <div className={styles.completeOverlay}>
          <div className={styles.completeCard}>
            ...
            <span>DATA CIRCUITS ONLINE</span>

            <h2>Logic Gates Unlocked</h2>

            <p>
              You stabilized the Data Circuits. Your next chamber introduces
              comparisons, boolean logic, branches, and control flow.
            </p>
...
export default CppDataCircuits;
