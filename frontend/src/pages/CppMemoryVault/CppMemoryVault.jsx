...
import styles from "./CppMemoryVault.module.css";

const LEVEL_ID = "cpp-memory-vault";
...
function saveProgress(userId, progress) {
  try {
    ...
    console.error(
      "[CodeLand] Unable to save C++ Memory Vault progress:",
      error,
    );
  }
}
...
function CppMemoryVault() {
  ...
  const content = cppMemoryVaultContent;
  ...
  const robotMessage =
    robotReaction.type === "happy"
      ? "Excellent. Memory Vault integrity is stable."
      : robotReaction.type === "sad"
        ...
        : runnerAvailable
          ...
          : "Memory Terminal is online. Backend compilation comes next.";
              ...
              <>
                <div className={styles.eyebrow}>
                  {activeUnit.kind === "lesson" ? (
                    <>
                      <Code2 size={13} />
                      MEMORY TRAINING {activeUnitIndex + 1}
                    </>
                  ) : (
                    <>
                      <Trophy size={13} />
        ...
        >
          <div className={styles.chamberHeader}>
            <div>
              ...
              <strong>C++17 Memory Runtime</strong>
            </div>
      ...
      {levelComplete && (
        <div className={styles.completeOverlay}>
          <div className={styles.completeCard}>
            ...
            <span>MEMORY VAULT ONLINE</span>

            <h2>Object Forge Unlocked</h2>
