...
import styles from "./CppSyntaxCore.module.css";

const LEVEL_ID = "cpp-syntax-core";
...
function saveProgress(userId, progress) {
  try {
    ...
    console.error("[CodeLand] Unable to save C++ Syntax Core progress:", error);
  }
}
...
function CppSyntaxCore() {
  ...
  const content = cppSyntaxCoreContent;
  ...
  const robotMessage =
    robotReaction.type === "happy"
      ? "Excellent. Syntax Core systems are responding."
      : robotReaction.type === "sad"
        ...
        : runnerAvailable
          ...
          : "Compiler Chamber is online. Backend compilation comes next.";
      ...
      <section className={styles.workspace}>
        ...
        >
          <div className={styles.chamberHeader}>
            <div>
              <span>COMPILER CHAMBER</span>

              <strong>C++17 Runtime</strong>
            </div>
      ...
      {levelComplete && (
        <div className={styles.completeOverlay}>
          <div className={styles.completeCard}>
            ...
            <span>SYNTAX CORE ONLINE</span>

            <h2>Data Circuits Unlocked</h2>

            <p>
              You powered up the first C++ sector. Your next chamber introduces
              variables, data types, operators, and input.
            </p>
