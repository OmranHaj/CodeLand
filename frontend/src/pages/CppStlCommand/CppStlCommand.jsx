...
import styles from "./CppStlCommand.module.css";

const LEVEL_ID = "cpp-stl-command";
...
function saveProgress(userId, progress) {
  try {
    ...
    console.error("[CodeLand] Unable to save C++ STL Command progress:", error);
  }
}
...
function CppStlCommand() {
  ...
  const content = cppStlCommandContent;
  ...
  const robotMessage =
    robotReaction.type === "happy"
      ? "Excellent. STL Command Center systems are operating correctly."
      : robotReaction.type === "sad"
        ...
        : runnerAvailable
          ...
          : "Command Terminal is online. Backend compilation comes next.";
        ...
        <div className={styles.headerLeft}>
          ...
          <div className={styles.identity}>
            ...
            <div>
              ...
              <strong>STL COMMAND CENTER</strong>
            </div>
          </div>
        </div>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.robotCard}>
            ...
            <div className={styles.robotCopy}>
              <span>STL COMMAND CENTERER</span>
              ...
              <>
                <div className={styles.eyebrow}>
                  {activeUnit.kind === "lesson" ? (
                    <>
                      <Code2 size={13} />
                      STL TRAINING {activeUnitIndex + 1}
                    </>
                  ) : (
                    <>
                      <Trophy size={13} />
        ...
        >
          <div className={styles.chamberHeader}>
            <div>
              ...
              <strong>C++17 STL Runtime</strong>
            </div>
      ...
      {levelComplete && (
        <div className={styles.completeOverlay}>
          <div className={styles.completeCard}>
            ...
            <span>STL COMMAND CENTER ONLINE</span>

            <h2>Final System Build Unlocked</h2>

            <p>
              You forged reusable C++ objects with classes, constructors,
              encapsulation, inheritance, polymorphism, and composition. STL
